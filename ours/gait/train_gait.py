...
python train_gait.py --log saved_models --transformation_list high_pass low_high high_low identity --wl 16
"""
...
def parse_args():
    ...
    parser.add_argument('--train_root_dir', type=str, default='data/gait-in-neurodegenerative-disease-database-1.0.0',help='training data directory')
    ...
    parser.add_argument('--test_root_dir', type=str, default='data/gait-in-neurodegenerative-disease-database-1.0.0',help='test data directory')
